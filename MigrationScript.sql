...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20250521224022_Initial'
)
BEGIN
...
BEGIN
    CREATE TABLE [Authors] (
        ...
        [Nationality] nvarchar(450) NOT NULL,
...
BEGIN
    CREATE INDEX [IX_Authors_Nationality] ON [Authors] ([Nationality]);
END;
GO
...
BEGIN
    ...
    VALUES (N'20250521224022_Initial', N'8.0.16');
END;
GO
